...
#define EIS_TabOrig			4	 	//"O nome da tabela é obrigatorio."
...
#define EIS_VNAFolders  	25 		//"A variavel aFolders não é uma array." 
#define EIS_VNAIncFilters   26 		//"A variavel aIncludeFilters não é uma array."
#define EIS_VNAExcFilters   27 		//"A variavel aExcludeFilters não é uma array."   
#define EIS_CTREECREATE     28      //"Arquivo do CTree em criação."   
#define EIS_INDEXSERVER     29      //"Arquivo do CTree em criação."   
#define EIS_INDEXPORT     	30      //"Arquivo do CTree em criação."   
