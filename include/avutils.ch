//-------------------------------------------------------------------
// Assinatura sera utilizada para não permitir a alteração 
...
#DEFINE TTS_SAPI5   	1 // Solução FrameWork
#DEFINE TTS_SAPI4   	2 // Solução TOTVSTec
#DEFINE TTS_VVISION 	3 // Solução Virtual Vision (Binário)
//-------------------------------------------------------------------
// Ações do sintetizador
//-------------------------------------------------------------------
...
//-------------------------------------------------------------------
// Definições do Profile do Configurador de Voz
//-------------------------------------------------------------------
