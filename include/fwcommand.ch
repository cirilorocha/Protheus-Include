...
//-------------------------------------------------------------------
#DEFINE SM0_GRPEMP   01 // Código do grupo de empresas
#DEFINE SM0_CODFIL   02 // Código da filial contendo todos os níveis (Emp/UN/Fil)
#DEFINE SM0_EMPRESA  03 // Código da empresa
#DEFINE SM0_UNIDNEG  04 // Código da unidade de negócio
#DEFINE SM0_FILIAL   05 // Código da filial
...
#DEFINE SM0_SIZEARRAY  24 // Tamanho do Array da função FWLoadSM0(), sempre deverá ter o tamanho máximo dos defines acima
