//Cor base (para personalização de cores)
...
#DEFINE FWSTD_CBX	"TComboBox { font: arial; "+;
					...
					"}"+;
					"tLabel{color: #000000;}"+;
					FWGetCss("",CSS_SCROLLBOX)//pega as configurações do scrollbar
...
//TGET COM HASSBUTTON (CONSULTA PADRÃO, CALCULADORA E CALENDARIO)
...
//SCROLLBAR - TAMBÉM UTILIZADO NO BROWSE
...
//TGET TIPO MEMO
#DEFINE FWSTD_MULTIGET "Q3TextEdit{ color: #000000; "+;
						"    background-color: #FFFFFF; "+;
						"    border: 2px ridge #C5C9CA; "+;
						"    border-radius: 3px; }"+;
						"Q3TextEdit:hover { border: 2px ridge "+__aColorPallet[30]+";  }"+;
						"Q3TextEdit:focus { border: 2px ridge "+__aColorPallet[30]+";  }"+;
						"tLabel{color: #666666;}"
...
//Botão principal (focal) do browse
...
//Botão terciário (usado apenas para links)
