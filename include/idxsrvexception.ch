...
#define IDXEX_INDEX_LIST_ERROR	  	  				13    	//"É obrigatório informar uma lista com os indices para pesquisa."  
#define IDXEX_INDEX_ITEM_ERROR	  	  				14      //"Não foi informado o item para pesquisa."
#define IDXEX_INDEX_ORDER_ERROR	  					15      //"As flags de Ascending e Descendig não podem ser habilitadas ao mesmo tempo."
...
#define IDXEX_CREATE_FILE_ERROR	  			   		18      //"Não foi possivel criar o arquivo: [%1]."
#define IDXEX_OPEN_FILE_EXCLUSIVE_ERROR		   		19      //"Nao foi possivel abrir arquivo para criacao de indice (exclusivo)" 
#define IDXEX_CONFIGURATION_ERROR		   	 		20      //"Nao foi encontrado configuração para esse Index Name"
